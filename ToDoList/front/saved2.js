    ...
    $.get("data.json", function(data, status){
        if(status === "success"){
            ...
            data_doc.forEach(tache => {
                ...
                if (compteur < (page_actuelle * 5) && nb_page == 1) {
                    $('#taskList').prepend(`
...
$("#taskList").on("click", "input", function() {
    ...
    data_doc.forEach(tache => {
        ...
        if(compteur === 0 && nb_page === 0){
            nb_page++;
            $('#pagination').append(`
                <li class="page-item" id="previous"><a class="page-link active" href="#">Previous</a></li>
                <li class="page-item" id="${nb_page}"><a class="page-link" href="#">${nb_page}</a></li> 
            `)
            console.log("preivous et 1");
        }
...
$('#newTask').on('click', 'button', function() {
    ...
    // data_doc.id.sort(function(a, b){return b-a});
    data_doc.reverse();
    console.log(data_doc);
    data_doc.forEach(tache => {
